...
Sub Fedex_A03_Process()
    ...
    Range("A1").Select
    Debug.Print "Data extraction started at " & Now
    Stop
    ...
    Debug.Print "Data extraction ended at " & Now
    Beep
    MsgBox Range("$G$30").Value & " extraction pulls endend"
...
Public Sub RunAccessCPR_Qry()
    ...
    Set dbAcc = ThisWorkbook.Path & "\BaseLevel Pulls Jda.accdb"
    
    dbAcc.RunCommand acCmdQueryTypeSelect
